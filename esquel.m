...
tipo= '*.bmp'; %tipo del archivo a leer
directorio = 'D:\Escritorio\imagenes esqueletizadas mini\'; %directorio sin nombre de archivo
...
while changing
    ...
    BW_Thinned = BW_Thinned.*BW_Del;
	   ...
	   directorio_salida= strcat(directorio,'1\',I);
    imwrite(not(BW_Thinned),directorio_salida{:});
end
